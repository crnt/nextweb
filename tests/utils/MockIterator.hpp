...
class MockIterator : public utils::Iterator<MockIterator<Iter>, 
	typename std::iterator_traits<Iter>::iterator_category, typename std::iterator_traits<Iter>::value_type> 
{
